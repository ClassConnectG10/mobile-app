/**
 * ESTE MÓDULO ESTÁ DEPRECADO: ACTUALMENTE NO SE USA ESTE STORAGE
 * (FUE REEMPLAZADO CON Context PARA LOS DATOS DEL USUARIO Y EL PROPIO
 * STORAGE DE FIREBASE PARA LAS CREDENCIALES)
 */
