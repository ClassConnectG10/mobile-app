...
//   const [forumAnswer, setForumAnswer] = useState<ForumAnswer | null>(
//     null
//   );
...
//     if (!courseId || !answers || !forumQuestion) return;
//     // setIsLoading(true);
...
//     if (!forumQuestion || !answers || !users) return;
//     setIsLoading(true);
...
//             title: "Respuestas",
//             data: answers,
//             renderItem: renderAnswersSection(answers, users),
//           },
//         ]
//       : []),
//   ];
...
//       {isLoading || !forumQuestion || !users || !answers || !creator ? (
//         <View
//           style={{
//             flex: 1,
